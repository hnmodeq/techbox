    ...
    endpoints: [
      {
        ...
        body: "{ items: [{ slug, quantity }], customer: { name, phone, address, postalCode, city?, email? } } — قیمت فقط در سرور محاسبه می‌شود",
      },
      {
        method: "GET",
        path: "/api/orders",
        description: "دریافت سفارش متعلق به نشست فعلی یا با توکن امن سفارش",
        params: "id + token (سفارش مهمان) یا user=me",
      },
      {
        method: "POST",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        params: "username (viewer از نشست فعلی تعیین می‌شود)",
      },
      {
        method: "GET",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: "لغو عضویت با توکن اختصاصی",
        body: "{ token }",
      },
    ],
  },
