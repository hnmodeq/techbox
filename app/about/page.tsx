    ...
    <main className="min-h-screen" dir="rtl">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-0">
        ...
        <section className="rounded-xl border border-border bg-card p-8 sm:p-10 text-center">
          ...
          <Link
            href="/work-with-us"
            className="inline-flex items-center justify-center mt-6 px-6 py-2.5 rounded-lg bg-foreground text-background text-sm font-bold hover:bg-foreground/90 transition-colors"
          >
        ...
        <section className="text-center pb-8">
          <p className="text-sm text-muted-foreground mb-4">ما را در شبکه‌های اجتماعی دنبال کنید</p>
          <div className="flex items-center justify-center gap-3">
            {socials.map((s) => (
              <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" title={s.name}
                className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors">
