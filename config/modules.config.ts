...
const moduleList: ModuleMeta[] = [
  ...
  { key: "raid", slug: "raid", title: "RAID", titleFa: "محاسبه فضای ذخیره‌ساز", href: "/tools/raid-calculator", color: "var(--raid)", icon: "disk", descriptionFa: "محاسبه فضای ذخیره‌ساز" },
  { key: "subnet", slug: "subnet", title: "Subnet", titleFa: "محاسبه زیرشبکه", href: "/tools/subnet-calculator", color: "var(--subnet)", icon: "tools", descriptionFa: "محاسبه زیرشبکه" },
  ...
  { key: "raid-calculator", slug: "raid-calculator", title: "RAID Calculator", titleFa: "محاسبه فضای ذخیره‌ساز", href: "/tools/raid-calculator", color: "var(--raid)", icon: "disk", descriptionFa: "RAID / SHR" },
  { key: "nas-selector", slug: "nas-selector", title: "NAS Selector", titleFa: "انتخاب ذخیره‌ساز شبکه", href: "/tools/nas-selector", color: "var(--nas)", icon: "nas", descriptionFa: "انتخاب ذخیره‌ساز شبکه" },
  { key: "nvr-selector", slug: "nvr-selector", title: "NVR Selector", titleFa: "انتخاب ذخیره‌ساز دوربین", href: "/tools/nvr-selector", color: "var(--nvr)", icon: "nvr", descriptionFa: "انتخاب ذخیره‌ساز دوربین" },
  { key: "subnet-calculator", slug: "subnet-calculator", title: "Subnet Calculator", titleFa: "محاسبه زیرشبکه", href: "/tools/subnet-calculator", color: "var(--subnet)", icon: "tools", descriptionFa: "محاسبه زیرشبکه" },
];
...
export const toolRoutes = [
  {
    ...
    descriptionFa: "محاسبه ظرفیت قابل‌استفاده، تحمل خرابی و فضای ازدست‌رفته آرایه RAID",
    image: "https://nggwgcfkceuadvhxnczf.supabase.co/storage/v1/object/public/techbox/tools/home-cards/raid-calculator.webp",
    icon: "disk" as const,
    color: "var(--raid)",
    version: "v2",
  },
  {
    ...
    descriptionFa: "پیشنهاد NAS متناسب با ظرفیت، تعداد کاربران، نوع RAID و بودجه شما",
    image: "https://nggwgcfkceuadvhxnczf.supabase.co/storage/v1/object/public/techbox/tools/home-cards/nas-selector.webp",
    icon: "nas" as const,
    color: "var(--nas)",
    new: true,
  },
  {
    ...
    descriptionFa: "پیشنهاد NVR و فضای ذخیره‌سازی بر پایه تعداد دوربین، وضوح و مدت ضبط",
    image: "https://nggwgcfkceuadvhxnczf.supabase.co/storage/v1/object/public/techbox/tools/home-cards/nvr-selector.webp",
    icon: "nvr" as const,
    color: "var(--nvr)",
    new: true,
  },
  {
    ...
    descriptionFa: "محاسبه بازه IP، Subnet Mask، تعداد میزبان و CIDR شبکه",
    image: "https://nggwgcfkceuadvhxnczf.supabase.co/storage/v1/object/public/techbox/tools/home-cards/subnet-calculator.webp",
    icon: "tools" as const,
    color: "var(--subnet)",
  },
  {
    ...
    descriptionFa: "محاسبه توان UPS، باتری موردنیاز و زمان پشتیبانی تجهیزات رک",
    image: "https://nggwgcfkceuadvhxnczf.supabase.co/storage/v1/object/public/techbox/tools/home-cards/ups-calculator.webp",
    icon: "ups" as const,
    color: "var(--ups)",
    new: true,
  },
