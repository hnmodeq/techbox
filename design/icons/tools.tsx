...
export function NasToolIcon({ size = 72, className, title }: ToolIconProps) {
  return (
    <svg {...svgProps(size, className, title)}>
      {title && <title>{title}</title>}
      {/* chassis */}
      <rect x="14" y="10" width="44" height="52" rx="5" fill={BASE} />
      {/* drive bays */}
      <rect x="20" y="17" width="26" height="8" rx="2" fill={MID} />
      <rect x="20" y="28" width="26" height="8" rx="2" fill={MID} />
      <rect x="20" y="39" width="26" height="8" rx="2" fill={MID} />
      <rect x="20" y="50" width="26" height="8" rx="2" fill={PALE} />
      {/* bay handles */}
      <rect x="22" y="20" width="4" height="2" rx="1" fill={BASE} />
      <rect x="22" y="31" width="4" height="2" rx="1" fill={BASE} />
      <rect x="22" y="42" width="4" height="2" rx="1" fill={BASE} />
      <rect x="22" y="53" width="4" height="2" rx="1" fill={BASE} />
      {/* activity LEDs */}
      <circle cx="52" cy="21" r="2.5" fill={HOT} />
      <circle cx="52" cy="32" r="2.5" fill={PALE} opacity="0.6" />
      <circle cx="52" cy="43" r="2.5" fill={PALE} opacity="0.6" />
    </svg>
  );
}
...
export function NvrToolIcon({ size = 72, className, title }: ToolIconProps) {
  return (
    <svg {...svgProps(size, className, title)}>
      ...
      <rect x="16" y="22" width="9" height="5" rx="2.5" fill={MID} />
      {/* sun shield */}
      <rect x="23" y="11" width="34" height="6" rx="3" fill={MID} />
      {/* camera body */}
      <rect x="23" y="15" width="34" height="22" rx="6" fill={BASE} />
      {/* lens */}
      <circle cx="47" cy="26" r="8" fill={MID} />
      <circle cx="47" cy="26" r="4.5" fill={PALE} />
...
export function SubnetToolIcon({ size = 72, className, title }: ToolIconProps) {
  return (
    <svg {...svgProps(size, className, title)}>
      ...
      <rect x="34.5" y="21" width="3" height="11" rx="1.5" fill={MID} />
      {/* horizontal bus */}
      <rect x="14.5" y="31" width="43" height="3" rx="1.5" fill={MID} />
      {/* drops to each leaf */}
      <rect x="14.5" y="33" width="3" height="9" rx="1.5" fill={MID} />
      <rect x="34.5" y="33" width="3" height="9" rx="1.5" fill={MID} />
      <rect x="54.5" y="33" width="3" height="9" rx="1.5" fill={MID} />
      {/* root network */}
      <rect x="24" y="8" width="24" height="14" rx="4" fill={BASE} />
      <rect x="29" y="13" width="14" height="3.5" rx="1.75" fill={PALE} />
      {/* three subnets, evenly spaced, no overlap */}
      <rect x="6" y="42" width="19" height="14" rx="4" fill={MID} />
      <rect x="10" y="47" width="11" height="3.5" rx="1.75" fill={PALE} />
      <rect x="26.5" y="42" width="19" height="14" rx="4" fill={HOT} />
      <rect x="30.5" y="47" width="11" height="3.5" rx="1.75" fill="#FFFFFF" opacity="0.9" />
      <rect x="47" y="42" width="19" height="14" rx="4" fill={MID} />
      <rect x="51" y="47" width="11" height="3.5" rx="1.75" fill={PALE} />
    </svg>
  );
}
...
export function UpsToolIcon({ size = 72, className, title }: ToolIconProps) {
  return (
    <svg {...svgProps(size, className, title)}>
      {title && <title>{title}</title>}
      {/* rack frame */}
      <rect x="12" y="8" width="48" height="56" rx="5" fill={BASE} />
      <rect x="17" y="13" width="38" height="46" rx="3" fill={MID} opacity="0.35" />
      {/* rack units */}
      <rect x="20" y="16" width="32" height="7" rx="2" fill={MID} />
      <rect x="20" y="26" width="32" height="7" rx="2" fill={MID} />
      {/* UPS unit — battery with charge cells */}
      <rect x="20" y="47" width="32" height="11" rx="2.5" fill={PALE} />
      <rect x="23" y="50" width="6" height="5" rx="1" fill={BASE} />
      <rect x="31" y="50" width="6" height="5" rx="1" fill={BASE} />
      <rect x="39" y="50" width="6" height="5" rx="1" fill={HOT} />
      {/* power bolt */}
