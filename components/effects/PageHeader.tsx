...
export default function PageHeader({ colorVar, title, description, titleClassName, className, children }: PageHeaderProps) {
 return (
 <header className={cn("relative mb-6 overflow-hidden rounded-[var(--tb-radius-lg)] border border-[var(--tb-border)] bg-[var(--tb-bg-secondary)]/70 p-5 md:p-6", className)} dir="rtl">
 ...
 <div>
 <h1 className={cn("tb-text-hero md:tb-text-hero", titleClassName)}>{title}</h1>
