    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-[300px] overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer rounded-[var(--tb-chroma-card-radius)]"
          style={
            {
              "--card-border": c.borderColor || "transparent",
              background: c.gradient,
              "--spotlight-color": "var(--tb-chroma-spotlight)",
            } as React.CSSProperties
          }
        >
          <div
